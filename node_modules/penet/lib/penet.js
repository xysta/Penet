...
var Penet  = function(options){
    ...
    this.addHandle = function(requestMethod, handleName ,handle){
        this.handles[requestMethod][handleName] = handle;
    ...
    var requestListener = function(incomingMessage, response){
        doMessage(incomingMessage,function(){
            fs.readFile(me.static_dir + url.parse(incomingMessage.url).pathname, {
                 ...
                 * @type {string}
                 */
                var template = new Buffer(data).toString();
                /**
                 * case 1:
                 *      handle:
                 *      handle.method:
                ...
                if(me.handles[incomingMessage.method].hasOwnProperty(params.handle)
                    && me.handles[incomingMessage.method][params.handle].hasOwnProperty(params.method)){
