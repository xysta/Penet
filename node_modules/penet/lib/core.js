...
module.exports = {
    doMessage: function(incomingMessage, end){
        ...
        logger.info("URL: " + incomingMessage.url);
        incomingMessage.setEncoding("utf8");
        logger.info("Method: " + incomingMessage.method);
        if (incomingMessage.method == "GET"){
            logger.info("query: " + url.parse(incomingMessage.url).query);
            incomingMessage.params = data2JSON(queryString.parse(url.parse(incomingMessage.url).query));
            logger.info("params: " + JSON.stringify(incomingMessage.params));
            end();
